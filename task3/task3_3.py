...
reg_coef = 0.01
w0 = np.array([1, 1])
w0_plus = np.array([100, 100])
w0_minus = np.array([200, 200])

#w,s,h = barrier(X, y, reg_coef, w0_plus, w0_minus,  trace = True)
#print(w)
#print(s)
#print(h)

#w,s,h = subgrad(X, y, reg_coef, w0, trace = True)
#print(w)
#print(s)
#print(h)

w,s,h = prox_grad(X, y, reg_coef, w0, trace = True)
print(w)
print(s)
print(h)
